...
public class OI {
  ...
  public OI() {
    ...
    fightStick = new Joystick(0);
    upButton = new JoystickButton(fightStick, 3);
    downButton = new JoystickButton(fightStick, 2);
    intakeButton = new JoystickButton(fightStick, 1);
